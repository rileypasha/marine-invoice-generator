  ...
  ],
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background text-foreground data-[hovered]:bg-accent data-[hovered]:text-accent-foreground",
        secondary:
          "bg-secondary text-secondary-foreground data-[hovered]:bg-secondary/80",
        ghost: "text-foreground data-[hovered]:bg-accent data-[hovered]:text-accent-foreground",
