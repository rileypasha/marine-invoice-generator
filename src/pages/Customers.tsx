...
const Customers: React.FC = () => {
  ...
  // Note: queryState.q removed from dependencies to avoid server calls on search
  // Search is handled by client-side filtering for instant results
  useEffect(() => {
    setCurrentPage(1);
    fetchCustomers(1);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [queryState.activity, queryState.fleet, queryState.segment]);
