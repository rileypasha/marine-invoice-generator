...
const Vessels: React.FC = () => {
  ...
  const fetchVessels = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(`/api/v1/vessels?limit=10000`, {
        method: 'GET',
        headers: {
        ...
        {isLoading ? (
          <div className="w-full">
            <div className="flex items-center px-5 py-3 border-b border-gray-100 bg-gray-50/40">
              ...
              <div className="flex-[1.5] min-w-0 pr-3"><div className="h-3 w-10 bg-gray-200/50 rounded skeleton-shimmer" /></div>
              <div className="flex-[1.5] min-w-0 pr-3"><div className="h-3 w-10 bg-gray-200/50 rounded skeleton-shimmer" /></div>
              <div className="flex-[1] min-w-0 pr-3"><div className="h-3 w-14 bg-gray-200/50 rounded skeleton-shimmer" /></div>
            ...
            {Array.from({ length: 8 }).map((_, row) => (
              <div key={row} className="flex items-center px-5 py-3.5 border-b border-gray-50">
                ...
                <div className="flex-[1.5] min-w-0 pr-3"><div className="h-3.5 bg-gray-50 rounded skeleton-shimmer" style={{ width: `${50 + (row % 2) * 20}%` }} /></div>
                <div className="flex-[1.5] min-w-0 pr-3"><div className="h-3.5 bg-gray-50 rounded skeleton-shimmer" style={{ width: `${45 + (row % 3) * 18}%` }} /></div>
                <div className="flex-[1] min-w-0 pr-3"><div className="h-3.5 bg-gray-50 rounded skeleton-shimmer" style={{ width: `${55 + (row % 2) * 15}%` }} /></div>
